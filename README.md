...
To assess the % identity of our draft assemblies, we used a method developed by Wick et al. (2017) [2]. This method used their [chop_up_assembly.py](https://github.com/rrwick/Basecalling-comparison/blob/master/chop_up_assembly.py) and [read_length_identity.py](https://github.com/rrwick/Basecalling-comparison/blob/master/read_length_identity.py) scripts to assess the % identity of 10kb sections of each assembly. Our shell script, assembly_identity, runs all the required steps of this process, and outputs a .txt file giving the mean % identity for the whole assembly. assembly_identity requires chop_up_assembly.py, read_length_identity.py and Minimap2 to be available in your PATH.
